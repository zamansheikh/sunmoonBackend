...
import {
  ...
  IStoreCategoryModel,
} from "../../models/store/store_category_model";
...
export interface IStoreCategoryRepository {
  ...
  getCategoryConditionally(
    condition: Partial<IStoreCategory>,
  ): Promise<IStoreCategoryDocument | null>;
...
export default class StoreCategoryRepository implements IStoreCategoryRepository {
  ...
  async getCategoryConditionally(
    condition: Partial<IStoreCategory>,
  ): Promise<IStoreCategoryDocument | null> {

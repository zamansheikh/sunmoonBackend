...
import GreedyGameDisconnectRouter from "./greedy_game/routes/disconnect_webhook_route";
import GreedyGameAdminRoutes from "./greedy_game/routes/admin_routes";
...
app.use("/api/game", GreedyGameDisconnectRouter);
app.use("/api/admin/game", GreedyGameAdminRoutes);
